...
namespace xbox  
{
	namespace Cleaning 
	{
		...
		VOID Go_Clean_HV()
		{
			...
			MemoryBuffer mbHV;
			xbox::utilities::readFile("HDD:\\HVCleaner\\HV-base.bin", mbHV);
			...
			xbox::utilities::readFile("HDD:\\HVCleaner\\salts.bin", mbSalts);
			...
			MemoryBuffer mbCh;
			xbox::utilities::readFile("HDD:\\HVCleaner\\challenge.bin", mbCh);
			...
			mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump").c_str());
			int j = 0;
			for(int p = 0; p  <= 255; p++)
			{
				if(!xbox::utilities::fileExists(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i", p).c_str()))
				{
					mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i", p).c_str());
					mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\xke", p).c_str());
					mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\MySalts", p).c_str());
					mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\ECCSalt", p).c_str());
					mkdir(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\Salts", p).c_str());
					
					DumpHV((char*)xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\HV", p).c_str());
					DumpSRAM((char*)xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\Cache.bin", p).c_str());
					DumpKeys((char*)xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\Keys.bin", p).c_str());
			...
			for (int i = 0; i <= 255; i++)
			{
				...
				xbox::utilities::writeFile(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\ECCSalt\\0x%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X.bin", j, pSalt[0], pSalt[1], pSalt[2], pSalt[3], pSalt[4], pSalt[5], pSalt[6], pSalt[7], pSalt[8], pSalt[9], pSalt[10], pSalt[11], pSalt[12], pSalt[13], pSalt[14], pSalt[15]).c_str(), ECCSalt, 0x02);
				...
				xbox::utilities::writeFile(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\xke\\0x%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X%X.bin", j,  pSalt[0], pSalt[1], pSalt[2], pSalt[3], pSalt[4], pSalt[5], pSalt[6], pSalt[7], pSalt[8], pSalt[9], pSalt[10], pSalt[11], pSalt[12], pSalt[13], pSalt[14], pSalt[15]).c_str(), Buffer2, 0x100);
				...
				xbox::utilities::writeFile(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\MySalts\\0x%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X.bin", j, pSalt[0], pSalt[1], pSalt[2], pSalt[3], pSalt[4], pSalt[5], pSalt[6], pSalt[7], pSalt[8], pSalt[9], pSalt[10], pSalt[11], pSalt[12], pSalt[13], pSalt[14], pSalt[15]).c_str(), DUMP, 0x70);
				...
				xbox::utilities::writeFile(xbox::utilities::va("HDD:\\HVCleaner\\dump\\%i\\Salts\\%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X%02X.bin", j, pSalt[0], pSalt[1], pSalt[2], pSalt[3], pSalt[4], pSalt[5], pSalt[6], pSalt[7], pSalt[8], pSalt[9], pSalt[10], pSalt[11], pSalt[12], pSalt[13], pSalt[14], pSalt[15]).c_str(), DUMP2, 0x30);
